...
class ChannelDoesNotExistError(Error):
  def __init__(self, channel, current_user=None):
    self.channel = channel
    self.current_user = current_user

  @property
  def message(self):
    return "Channel %s does not exist" % self.channel
...
class AdminRequiredError(UserVisibleError):
  def to_html(self):
